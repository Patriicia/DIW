...
if ($result->num_rows > 0) {
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") { 
    ...
    if (count($_POST) > 0) {
      ...
      $Usuario_nombre = test_input($_POST['Usuario_nombre']);
      $Usuario_apellido1 = test_input($_POST['Usuario_apellido1']);
      $Usuario_apellido2 = test_input($_POST['Usuario_apellido2']);
      $Usuario_domicilio = test_input($_POST['Usuario_domicilio']);
      $Usuario_poblacion = test_input($_POST['Usuario_poblacion']);
      $Usuario_provincia = test_input($_POST['Usuario_provincia']);
      $Usuario_nif = test_input($_POST['Usuario_nif']);
      $Usuario_numero_telefono = test_input($_POST['Usuario_numero_telefono']);
      $Usuario_fotografia = test_input($_POST['Usuario_fotografia']);
  ...
  <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
            <div class="container px-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <li class="nav-item"><a class="nav-link" href="perfilUsuario.php">Mi perfil</a></li>
                  ...
                  <form class="form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" id="registrationForm">
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input type="text" class="form-control" name="Usuario_nombre" id="first_name" value='<?php echo $Usuario_nombre ?>'>
                          </div>
                      </div>
                      <div class="form-group">
                          <div class="row">
                          <div class="col">
                            ...
                            <input type="text" class="form-control" name="Usuario_apellido1" id="Usuario_apellido1" value='<?php echo $Usuario_apellido1 ?>'>
                          </div>
                          <div class="col">
